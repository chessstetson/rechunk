...
class BatchDocumentVectorizationWorkflow:
    """
    Single orchestration workflow: one ``vectorize_content_for_strategy`` activity per hash, in order.

    Per-hash parallelism is deferred; this matches one workflow in the UI and one history stream.
    """
